...
The 'ITI_ICP_BRASIL' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/ITI_ICP_BRASIL/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] ITI_ICP_BRASIL_etl` to your workspace.

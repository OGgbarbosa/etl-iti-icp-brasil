...
def upload_volume_bronze_iti_numeros():
    ...
    caminho_raw = "/Volumes/lakehouse_iti/0_raw/raw/numeros.json"
    caminho_bronze = "/Volumes/lakehouse_iti/1_bronze/raw/numeros.csv"
...
def upload_tabela_bronze_iti_numeros():
    ...
    # Criação/Carga da tabela Delta no Unity Catalog a partir do CSV salvo no Volume
    tabela_destino = "lakehouse_iti.1_bronze.numeros"
    print(f"Criando/atualizando tabela Delta: {tabela_destino}...")
